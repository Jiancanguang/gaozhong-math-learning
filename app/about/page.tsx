const updateLogs = [
  {
    date: '2026-03-08',
    badge: '新功能',
    title: '班级宠物系统上线：守护神兽养成、徽章收集、小卖部兑换',
    summary: '全新的班级宠物养成系统，学生选择守护神兽，老师通过喂养食物驱动宠物升级成长，满级毕业获得徽章，徽章可兑换小卖部奖品。',
    details: [
      '21种可选守护神兽，10级成长体系（蛋蛋→毕业）',
      '老师后台：班级管理、批量添加学生、批量喂养、积分加减、等级配置',
      '学生端：选择神兽、查看成长进度、徽章墙、小卖部兑换',
      '完整的操作记录和成长日志',
      '小卖部商品管理和徽章兑换系统'
    ]
  },
  {
    date: '2026-03-08',
    badge: '体验优化',
    title: '成长追踪系统全面优化：录入体验、分页、家长报告增强',
    summary: '成长追踪系统完成一轮整体优化，涵盖录入体验改进、列表性能优化、家长报告增强和代码整理四个方向。',
    details: [
      '课堂和考试录入表单拆分为独立页面，列表页新增分页功能',
      '录入表单适配移动端，桌面端表格 + 手机端卡片双布局',
      '家长报告新增日期范围筛选，统计数据随筛选实时变化',
      '提取 18 个页面的重复格式化函数为统一共享模块',
      '所有列表页新增加载骨架屏，班级页改用轻量计数查询'
    ]
  },
  {
    date: '2026-03-07',
    badge: '系统整合',
    title: '成长追踪系统统一，移除旧版成绩追踪和离线版成长追踪',
    summary: '成长追踪 V2 已经完整覆盖了旧版成绩追踪系统和离线版成长追踪的所有功能，正式将两套旧系统下线，导航栏统一为成长追踪入口。',
    details: [
      '移除成绩跟踪系统 V1（/admin/score-tracker）和公开介绍页（/score-tracker）',
      '移除离线版成长追踪 V1（仪表盘、学生管理、课堂记录、历史记录）',
      '导航栏新增成长追踪入口，直接跳转至 Growth V2',
      '首页焦点卡片更新为成长追踪系统'
    ]
  },
  {
      ...
      <section className="mt-6 rounded-2xl border border-tide/10 bg-white/80 p-6">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-ink/80">最新的改动排在最上面，往下翻可以看到从 2026-02-25 建站以来的完整记录。</p>
          </div>
